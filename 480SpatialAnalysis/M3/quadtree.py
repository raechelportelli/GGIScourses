"""
Ref: https://scipython.com/blog/quadtrees-2-implementation-in-python/
"""
import numpy as np
...
class Point:
    ...
    Each Point object may be associated with a label object.
    ...
    def __repr__(self):
        return '{}: {}'.format(str((self.x, self.y)), repr(self.label))
    def __str__(self):
